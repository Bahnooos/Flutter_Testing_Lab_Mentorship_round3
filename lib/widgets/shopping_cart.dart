      ...
      children: [
        Wrap(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () => setState(() {
                itemsService.addItem('3', 'iPad Pro', 1099.99);
              }),
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Text('Total Items: ${itemsService.totalItems}'),
                  ElevatedButton(
                    onPressed: () => setState(() {
                      itemsService.clearCart;
                    }),
              ...
              Text('Subtotal: \$${itemsService.subtotal.toStringAsFixed(2)}'),
              Text(
                'Total Discount: \$${itemsService.totalDiscount.toStringAsFixed(2)}',
              ),
              const Divider(),
              Text(
                'Total Amount: \$${itemsService.totalAmount.toStringAsFixed(2)}',
        ...
        itemsService.items.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final item = itemsService.items[index];
                    ...
                    child: ListTile(
                      ...
                      trailing: Row(
                        ...
                        children: [
                          IconButton(
                            onPressed: () => setState(() {
                              itemsService.updateQuantity(item.id, -1);
                            }),
                          ...
                          IconButton(
                            onPressed: () => setState(() {
                              itemsService.removeItem(item.id);
                            }),
